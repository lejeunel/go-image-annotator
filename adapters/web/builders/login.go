		...
		Span(
			...
			Form(
				...
				Div(
					...
					A(
						Class(
							"mt-2 block text-xs font-medium text-primary underline-offset-2 hover:underline focus:underline focus:outline-hidden dark:text-primary-dark",
						),
						Href(rt.ForgotPasswordFormUrl),
